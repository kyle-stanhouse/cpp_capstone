...
class ProcessImage{
	...
	ros::ServiceClient client; // Define a service client 
...
int main(int argc, char** argv)
{
    ...
    ros::ServiceServer service = n1.advertiseService("/ball_chaser_OOP/command_robot", handle_drive_request);
